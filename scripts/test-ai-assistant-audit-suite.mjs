...
const scripts = [
  'test-ai-assistant-oil-request', 'test-ai-assistant-service-type', 'test-ai-assistant-e2e', 'test-ai-assistant-holdout', 'test-ai-assistant-metrics', 'test-ai-assistant-customer-dialogue',
