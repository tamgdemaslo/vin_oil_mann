...
// code.
const cases = [
  ["case-01", "Kia Sorento XM", "automatic_transmission", "Hyundai/Kia ATF SP-IV", 5, 7.1, "internal_requires_disassembly"],
  ["case-02", "BMW 740e", "automatic_transmission", "BMW ATF", 5, 8.0, "unknown", "hybrid"],
  ["case-03", "Ford Kuga", "automatic_transmission", "Ford MERCON LV", 5, 8.5, "pan_service"],
  ["case-04", "BMW 5 Series", "automatic_transmission", "ZF LifeguardFluid 8", 7, 9.0, "integrated_with_pan"],
  ["case-05", "Kia Sorento UM", "automatic_transmission", "Hyundai/Kia ATF SP-IV", 8, 8.3, "internal_requires_disassembly"],
  ["case-06", "Honda Pilot", "automatic_transmission", "Honda ATF DW-1", 4, 8.0, "internal_requires_disassembly"],
  ["case-07", "SsangYong New Actyon", "automatic_transmission", "ATF specification requires confirmation", 5, 9.5, "unknown"],
  ["case-08", "Lexus GS300", "automatic_transmission", "Toyota ATF WS", 3, 8.7, "internal_requires_disassembly"],
  ["case-09", "BMW 3 Series", "automatic_transmission", "BMW ATF 6", 6, 8.0, "integrated_with_pan"],
  ["case-10", "BMW 5 Series E34", "automatic_transmission", "ATF specification requires plate verification", 4, 8.0, "unknown"],
  ["case-11", "Skoda Octavia", "dsg", "VW G 052 182", 2, 7.0, "external_replaceable"],
  ["case-12", "Hyundai ix35", "automatic_transmission", "Hyundai/Kia ATF SP-IV", 5, 7.3, "internal_requires_disassembly"],
  ["case-13", "Audi A6 C5", "automatic_transmission", "VW G 052 162", 4, 9.0, "unknown"],
  ["case-14", "Lada Granta", "automatic_transmission", "ATF requires automatic gearbox confirmation", 3, 6.0, "unknown", "manual"],
  ["case-15", "Volkswagen Golf", "automatic_transmission", "ATF requires automatic gearbox confirmation", 3, 6.0, "unknown", "manual"],
  ["case-16", "Kia Sportage QL", "automatic_transmission", "Hyundai/Kia ATF SP-IV", 4, 6.7, "internal_requires_disassembly"],
  ["case-17", "Audi A6 C6", "automatic_transmission", "VW G 055 162", 4, 9.0, "unknown"],
  ["case-18", "Skoda Kodiaq", "dsg", "VW DSG specification requires aggregate confirmation", 6, 7.0, "unknown"],
  ["case-19", "Audi Q5 Hybrid", "automatic_transmission", "VW G 060 162 A2", 4, 8.6, "integrated_with_pan", "q5-hybrid"],
  ["case-20", "Mitsubishi Pajero IV", "automatic_transmission", "DiaQueen ATF SP-III", 3, 9.7, "internal_requires_disassembly"],
];
...
for (const [caseId, vehicleDisplayName, type, requiredFluidSpec, partial, total, filterAccess, mode] of cases) {
  ...
  assert.deepEqual(normalizedPlan(first), normalizedPlan(second), `${caseId}: identical normalized input must produce the same technical result`);
  ...
  if (mode === "q5-hybrid") assert.equal(first.hardBlockers.some((blocker) => /HYBRID|SAFETY_CRITICAL/u.test(blocker.code)), true, `${caseId}: a model label and URL cannot verify a hybrid powertrain`);
}

console.log(`AI quote-and-tech-card field replay — ${cases.length} synthetic profile cases × 2 runs passed`);
