...
const wanted=new Set(['ee158d685edade6f']);
...
try{
 ...
 await writeFile(resolve(dir,'outlander-market-gap-diagnosis-v1.json'),JSON.stringify({kind:'OUTLANDER_MARKET_GAP_DIAGNOSIS',hashes,findings,productionApplyAllowed:false,limitations:['Recorded provider responses and intercepted DB; no real VIN requests.','Offered catalogue candidates are not asserted correct.','Single recorded Outlander case; market evidence only, no override authorization.']},null,2)+'\n',{flag:'wx'});
