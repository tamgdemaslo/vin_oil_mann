...
assert.equal(new Set(revisions.map(r=>r.originalRevision.id)).size,version==='v9'?2018:version==='v8'?2007:version==='v7'?1992:version==='v6'?1971:['v4','v5'].includes(version)?1958:1932);
