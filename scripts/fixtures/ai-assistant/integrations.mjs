...
export async function resolveMannVehicle(args) { const f=globalThis.__tgmReplay;f.mannCalls++;(f.mannVehicles ??= []).push(args.vehicle);if(f.resolveMannVehicle)return f.resolveMannVehicle(args);return f.mann ?? {status:'unresolved',decision:'NO_MATCH',selectedApplication:null,filters:[],localMatches:[],candidates:[]}; }
