...
export async function resolveMannVehicle() { const f=globalThis.__tgmReplay;f.mannCalls++;return f.mann ?? {status:'unresolved',decision:'NO_MATCH',selectedApplication:null,filters:[],localMatches:[],candidates:[]}; }
