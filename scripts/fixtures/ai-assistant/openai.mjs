...
export function createOpenAIClient() {
 return { responses: { create: async (body, options) => {
  ...
  if (body.tools?.some(tool => tool.type === 'web_search')) return { id:'frozen-research', output:[{type:'message',content:[{type:'output_text',text:'В замороженных источниках нет применимого момента или температуры. Нужна проверка.'}]}],usage:{input_tokens:20,output_tokens:20} };
