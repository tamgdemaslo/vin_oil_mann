...
const BRANCH_SCOPED_MODELS = new Set([
  ...
  "IntegrationOnboardingSession", "MessengerAttachment", "MessengerMediaJob",
  ...
  "LocalInventorySyncState",
  "MoySkladDemandSync", "MoySkladDemandPositionSync", "MoySkladAnalyticsSyncState",
