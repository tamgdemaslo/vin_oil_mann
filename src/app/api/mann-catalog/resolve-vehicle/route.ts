...
export async function POST(request: NextRequest) {
  ...
  try {
    const result = await resolveMannVehicle({ organizationId: parsed.data.organizationId ?? "default", warehouseId: parsed.data.warehouseId, vehicle: parsed.data.vehicle });
